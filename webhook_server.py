...
def payment_success():
    order_id = request.args.get('order_id', 'neizvesten')
    return f"""
    <!DOCTYPE html>
    <html>
    ...
    <p>Order #{order_id} paid</p>
    <a href="https://t.me/platezhka_robot" class="btn">Back to bot</a>
    </body>
    </html>
    """
